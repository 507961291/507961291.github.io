 ...
 const weatherAPI = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=c5cf8b8a6ee5cb33fce30431f6f49c46&units=imperial";
 ...
 fetch(weatherAPI)
  ...
  const forecastAPI = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=c5cf8b8a6ee5cb33fce30431f6f49c46&units=imperial";
  fetch(forecastAPI)
  .then((response) => response.json())
  .then((forecastData) => { 
